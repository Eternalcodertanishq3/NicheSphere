          ...
          child: Column(children: [
            ...
            Expanded(
              child: GridView.builder(
                ...
                itemCount: MockData.featuredEvents.length + MockData.upcomingEvents.length,
                itemBuilder: (_, i) {
                  final events = [...MockData.featuredEvents, ...MockData.upcomingEvents];
                      ...
                      child: Stack(children: [
                        ...
                        Positioned.fill(child: DecoratedBox(decoration: BoxDecoration(
                          gradient: LinearGradient(begin: Alignment.topCenter, end: Alignment.bottomCenter,
                            colors: [Colors.transparent, Colors.black.withOpacity(0.7)], stops: const [0.3, 1.0])))),
