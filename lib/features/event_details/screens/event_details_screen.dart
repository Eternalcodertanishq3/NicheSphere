...
class EventDetailsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final allEvents = [...MockData.featuredEvents, ...MockData.upcomingEvents];
    final event = allEvents.firstWhere((e) => e.id == eventId, orElse: () => MockData.featuredEvents.first);
    ...
    return Scaffold(
      body: Stack(children: [
                    ...
                    Row(children: [
                      ...
                      if (event.maxAttendees > 0) ...[
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(color: AppColors.warning.withOpacity(0.2), borderRadius: AppBorderRadius.pill),
        ...
        Positioned(left: 24, right: 24, bottom: 24 + MediaQuery.of(context).viewPadding.bottom,
          child: AppButton(label: 'Attend Event', icon: Icons.check_circle_outline_rounded,
            onTap: () {}).animate().fadeIn(delay: 500.ms).slideY(begin: 0.3, end: 0)),
      ]),
    );
  }
